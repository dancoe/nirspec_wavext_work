...
2. **v8 (r=0.5")**: Project custom fixed circular aperture, no background subtraction, no aperture correction.
3. **r=0.45"**: Reference fixed aperture with background annulus subtraction (1.0-1.2") if SRCTYPE=POINT.
