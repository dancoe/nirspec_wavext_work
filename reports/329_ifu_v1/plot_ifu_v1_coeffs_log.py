...
def plot_log_coeffs():
    ...
    fig.suptitle('IFU Calibration v1 (329) — k/α/β coefficients', fontsize=14)
    ...
    for ax, grating in zip(axes, ['G140M', 'G235M']):
        ...
        ax.set_yscale('log')
        ax.set_ylim(1e-4, 5.0) # IFU k can be ~2
    ...
    plt.tight_layout()
    outpath = f'{OUTPUT_DIR}/ifu_v1_coeffs_log.png'
