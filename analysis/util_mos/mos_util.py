...
def show_MOS_rate_files(rate_files, slit_models=[], save_plot=False, close_plot=False, dpi=200, integration=None,
                        vmin=None, vmax=None, show_colorbar=True, source_ids=None):
        ...
        if len(slit_models):
            ...
            for slit in slit_model.slits:
                if source_ids is not None:
                    if slit.source_id not in source_ids:
                        continue
